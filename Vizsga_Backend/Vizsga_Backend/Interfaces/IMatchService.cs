...
namespace Vizsga_Backend.Services
{
    ...
    {
        Task CreateMatchAsync(MatchModel match);
        Task<MatchModel> GetMatchByIdAsync(string matchId);
        ...
        Task CreateNextMatchAsync(MatchModel oldMatch, string winnerPlayerId);
    }
}
