...
namespace Vizsga_Backend.Controllers
{
    ...
    public class MatchController : ControllerBase
    {
        ...
        [Authorize]
        public async Task<IActionResult> ValidateTournamentPassword(string matchId, [FromBody] ValidatePassword password)
        {
            try
            {
                ...
                if (BCrypt.Net.BCrypt.Verify(password.Password, matchHeader.JoinPassword))
                {
